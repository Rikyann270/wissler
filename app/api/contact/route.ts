  ...
  try {
    ...
    const htmlContent = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        <h2 style="color: #0b1c3f; border-bottom: 2px solid #e9a115; padding-bottom: 10px; margin-top: 0;">New Contact Form Message</h2>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
          ...
          <tr style="border-top: 1px solid #f0f0f0;">
            ...
            <td style="padding: 8px 0; color: #111111; text-transform: capitalize;">${subject}</td>
          </tr>
        </table>

        <div style="margin-top: 20px; padding-top: 15px; border-top: 2px solid #f0f0f0;">
          <h4 style="color: #0b1c3f; margin-bottom: 8px; margin-top: 0;">Message:</h4>
        ...
        <div style="margin-top: 30px; font-size: 11px; color: #888888; text-align: center; border-top: 1px solid #e0e0e0; padding-top: 15px;">
          This message was sent from the Wissler Cargo Contact Form.
        </div>
      </div>
    `;
